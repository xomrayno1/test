...
<script type="text/javascript">
	...
	document.getElementById('nameSearch').value = document.getElementById('valueSearch').value;
	document.getElementById('categorySearch').value = document.getElementById('valueCategory').value ;
	document.getElementById('dateFrom').value = document.getElementById('valueDatefrom').value ;
	document.getElementById('dateTo').value = document.getElementById('valueDateto').value;
