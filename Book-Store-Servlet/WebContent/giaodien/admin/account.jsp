		...
		<div class="row">
			...
			<table class="table table-bordered table-hover text-center ">
					<tr>
						...
						<td colspan="1">
							<select class="form-control" name="role" form="form-search">
					...
					<tr>
						<c:if test="${error != null}">
							<td colspan="9" class="alert alert-danger alert-dismissible">
					...
					<tr>
						<td colspan="9">
							<button data-toggle="modal" data-target="#modal_add" class="btn btn-primary" id="add">Thêm</button>
						</td>
					</tr>
				</table>		
	...
	btnUpdate[i].addEventListener('click',function(){
		...
		var xhttp = new XMLHttpRequest();
	 	...
	 	roleAccount.addEventListener('change',function(){
			 ...
			 if(roleAccount.value === 'ROLE_NULL') {
