...
<body>
<c:url value="/user/address/create" var="url"></c:url>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="row">
					...
					<div class="col-sm-8">
				<form method="POST" action='<c:url value="/user/address/create"></c:url>' id="form-create">
					<table>
						<tr>
							<td>Họ và tên :</td>
							<td><input type="text" name="name" required="required" id="name" class="form-control"></td>
						</tr>
						...
						<tr>
							<td>Số điện thoại :</td>
							<td><input type="text" name="phone" required="required" id="phone" class="form-control"></td>
						</tr>
						<tr class="alert-error">
						...
						<tr class="alert-error">
							<td colspan="2"> <p id="alert-provincial" class="error"></p> </td>
						</tr>
						<tr>
							<td>Quận huyện :</td>
							<td>
						...
						<tr class="alert-error">
							<td colspan="2"> <p id="alert-district" class="error"></p> </td>
						</tr>
						<tr>
							<td>Phường xã :</td>
							<td>
						...
						<tr class="alert-error">
							<td colspan="2"> <p id="alert-ward" class="error"></p> </td>
						</tr>
						<tr>
							<td>Chi tiết :</td>
							<td><textarea rows="4" cols="22" name="description"
									required="required" class="form-control" id="descript"></textarea></td>
						</tr>
						<tr class="alert-error">
						...
						<tr>
							...
							<input type="checkbox" name="status" value="1"> Đặt làm địa chỉ mặt định
							</td>
						</tr>
						<tr class="alert-error">
							<td colspan="2"> <p  class="error">${error}</p></td>
						</tr>
						<tr>
							<td colspan="2" style="text-align: center;"  ><button type="submit" class="btn btn-info">Thêm</button></td>
						</tr>
					</table>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var formAddress = document.getElementById('form-create');
